...
**React Electron Template** helps you build multi-platform desktop apps more easily. **Don't worry about the configuration 🔨** this template will take care of that, so you can focus on your code⌨️ and project ideas 💡. The idea is to solve the common issues with connecting those frameworks, build a robust template to support daily development needs, and help developers use better practices while working with popular JavaScript components.
...
The Template comes pre-bundled with a `package.json` file that contains the list of modules you need to start your application.
...
If the localhost 5050 port number is already in use! or if you like to change your **React application number.**
...
- Click the green button to run debug or press `F5` to start debugging.
...
If you want to clean the cache files and node_modules cache run this below command 👇:
...
NOTE: This command shows you the warnings and errors in your code.
...
Run the below command 👇 to prepare Husky:
...
To run your code in production mode run this command 👇:
...
If you need to debug your application in production mode run this 👇 command and it will show you the Electron **DevTools** for debugging.
...
NOTE: This is a testing build only, don't move it for **Distribution**.

## 📦 Release a Distribution Version

This guide will teach you how to build and distribute your application for **multi-platform**, It's time to release your million-dollar projects.

**NOTE:** To avoid **Unknown publisher** errors you need to [Code Signing](https://www.venafi.com/education-center/code-signing/what-is-code-signing) on your project for more read this [Documentation .](https://www.electronjs.org/docs/latest/tutorial/distribution-overview)
...
**I hope 🙏 it will help you! Give a ⭐️ to support this project!**

If you like 💗 the project, there is another way to support us
